    ...
    <header className="sticky top-0 z-50 w-full border-b border-white/5 bg-phone/80 px-4 py-3 backdrop-blur-md">
      <div className="grid grid-cols-3 items-center gap-2">
        <div className="flex flex-col items-center justify-center leading-none">
          <span
            className="text-[1.05rem] font-black leading-none tracking-tighter text-transparent"
            style={{
              WebkitTextStroke: '1.2px white',
              textShadow: '0 0 14px rgba(139,0,0,0.9)',
              backgroundImage: 'linear-gradient(to bottom, #6b21a8, #8b0000)',
          ...
          <span
            ...
            style={{
              WebkitTextStroke: '1.2px white',
              textShadow: '0 0 14px rgba(139,0,0,0.9)',
              backgroundImage: 'linear-gradient(to bottom, #8b0000, #6b21a8)',
              WebkitBackgroundClip: 'text',
              backgroundClip: 'text',
            }}
          >
